...
public:
    ...
    //Inline
    inline void SetDestinationName(CString destinationName)
    {
        this->destinationName = destinationName;
    }

    inline void SetOutputContext(COutputContext *pOutputCtx)
    {
